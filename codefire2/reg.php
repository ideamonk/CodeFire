<html><head><meta http-equiv="Content-Language" content="en-us"><meta http-equiv="Content-Type" content="text/html; charset=windows-1252"><title>Welcome to CodeFire</title></head><body><div align="center">  <center>  <table border="0" cellpadding="0" style="border-collapse: collapse" bordercolor="#111111" width="760" id="AutoNumber1">    <tr>      <td width="760" height="220"  align="center" valign="top">      <div align="center">        <center>        <table border="0" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#111111" width="90%" id="AutoNumber3" height="132">          <tr>            
		...
		if ($pwde == "err"){
			echo "<tr><td>Password : </td><td><input type='password' size='18' maxlength='80' name='upwd' value=''></td></tr><tr><td>Confirm password :</td><td><input type='password' size='18' maxlength='40' name='upwd2' value=''><font face='arial' color='red' size='1'><b>ReCheck Password</b></font></td></tr>";
			}
		elseif ($pwde == "err1"){
			echo "<tr><td>Password : </td><td><input type='password' size='18' maxlength='80' name='upwd' value=''></td></tr><tr><td>Confirm password :</td><td><input type='password' size='18' maxlength='40' name='upwd2' value=''><font face='arial' color='red' size='1'><b>Password Too Short ( Min 6 chars )</b></font></td></tr>";
			}
		else
			echo "<tr><td>Password : </td><td><input type='password' size='18' maxlength='80' name='upwd' value=''></td></tr><tr><td>Confirm password :</td><td><input type='password' size='18' maxlength='40' name='upwd2' value=''></td></tr>";
